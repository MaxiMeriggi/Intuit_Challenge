...
namespace Intuit.Application.Common.MappingProfiles
{
    public class ClientMapping : Profile
    {
        public ClientMapping()
        {
            #region ClienteRequestDto
            CreateMap<ClienteRequestDto, Client>()
                .ForMember(
                    dest => dest.Id,
            ...
            #region ClienteResponseDto
            CreateMap<ClienteResponseDto, Client>()
                .ForMember(
                    dest => dest.Id,
                    opt => opt.MapFrom(src => src.Id))
                .ForMember(
